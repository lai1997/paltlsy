...
def DC1(window, pos, neg, alphabet, costfun, maxCost, AprUnqChkTyp, NegType):
    ...
    phi11 = DC1(window, p1, n1, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    phi11AcceptsP2 = not False in LTLmatch(p2, alphabet, phi11)
    phi11RejectsN2 = not True  in LTLmatch(n2, alphabet, phi11)
    if phi11AcceptsP2 and phi11RejectsN2:
        return phi11

    if phi11RejectsN2:
        left = phi11
    else:
        phi12 = DC1(window, p1, n2, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    ...
    phi21 = DC1(window, p2, n1, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    phi21AcceptsP1 = not False in LTLmatch(p1, alphabet, phi21)
    phi21RejectsN2 = not True  in LTLmatch(n2, alphabet, phi21)
    if phi21AcceptsP1 and phi21RejectsN2:
        return phi21

    if phi21RejectsN2:
        right = phi21
    else:
        phi22 = DC1(window, p2, n2, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
...
def DC2(window, pos, neg, alphabet, costfun, maxCost, AprUnqChkTyp, NegType):
    ...
    phi11 = DC2(window, p1, n1, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    ...
    if phi11RejectsTheWholeN2:
        ...
        phi12 = DC2(window, p1, n2AndPhi11, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    ...
    phi21 = DC2(window, P2MinusLeft, n1, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    ...
    if phi21RejectsTheWholeN2:
        ...
        phi22 = DC2(window, P2MinusLeft, n2AndPhi21, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
...
def DC3(window, pos, neg, alphabet, costfun, maxCost, AprUnqChkTyp, NegType):
    ...
    if n2 == []:
        ...
        phi12 = DC3(window, p1, n2, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
        Phi11CanBeReplacedByPhi12 = not True in LTLmatch(n1, alphabet, phi12)
        if Phi11CanBeReplacedByPhi12:
            left = phi12
        else:
    ...
    phi21 = DC3(window, p2, n1, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
    ...
    if phi21RejectsTheWholeN2:
        ...
        phi22 = DC3(window, p2, n2, alphabet, costfun, maxCost, AprUnqChkTyp, NegType)
        Phi21CanBeReplacedByPhi22 = not True in LTLmatch(n1, alphabet, phi22)
        if Phi21CanBeReplacedByPhi22:
            right = phi22
        else:
